...
//        Employee expectedEmployee = new Employee("xiaohong",19,"female",7000,1, 1);
//        String actualName = employeeRepository.findFirstMeetTwoConditionEmployee('n',6000).getName();
//        assertThat(actualName).isEqualTo(expectedEmployee.getName());
//    }
//
//    @Test
...
//        Employee expectedEmployee = new Employee("xiaohong",19,"female",7000,1, 1);
//        String actualName = employeeRepository.findSalaryHighestAndIdIsSatisfied(1).getName();
//        assertThat(actualName).isEqualTo(expectedEmployee.getName());
//    }
//
//    @Test
...
//        Page<Employee> EmployeePage = employeeRepository.getEmployeePage(3,2);
...
//        String actualCompanyName = employeeRepository.findCompanyNameOfEmployee("xiaohong");
...
//        Integer actualLine = employeeRepository.getUpdateEffectedRows("xiaohong","xiaobai");
